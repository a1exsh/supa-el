...
(define-key supa-mode-map (kbd "SPC") 'supa-set-tile-at-point-spc)
(define-key supa-mode-map (kbd "z")   'supa-set-tile-at-point-zonk)
(define-key supa-mode-map (kbd "b")   'supa-set-tile-at-point-base)
(define-key supa-mode-map (kbd "M")   'supa-set-tile-at-point-murphy)
(define-key supa-mode-map (kbd "i")   'supa-set-tile-at-point-info)
(define-key supa-mode-map (kbd "c")   'supa-set-tile-at-point-chip)
(define-key supa-mode-map (kbd "h")   'supa-set-tile-at-point-hard)
(define-key supa-mode-map (kbd "E")   'supa-set-tile-at-point-exit)
(define-key supa-mode-map (kbd "d")   'supa-set-tile-at-point-disk)
(define-key supa-mode-map (kbd ">")   'supa-set-tile-at-point-port-lr)
(define-key supa-mode-map (kbd "V")   'supa-set-tile-at-point-port-ud)
(define-key supa-mode-map (kbd "<")   'supa-set-tile-at-point-port-rl)
(define-key supa-mode-map (kbd "^")   'supa-set-tile-at-point-port-du)
(define-key supa-mode-map (kbd "s")   'supa-set-tile-at-point-snik)
(define-key supa-mode-map (kbd "y")   'supa-set-tile-at-point-y-disk)
(define-key supa-mode-map (kbd "T")   'supa-set-tile-at-point-term)
(define-key supa-mode-map (kbd "r")   'supa-set-tile-at-point-r-disk)
(define-key supa-mode-map (kbd "|")   'supa-set-tile-at-point-port-v)
(define-key supa-mode-map (kbd "-")   'supa-set-tile-at-point-port-h)
(define-key supa-mode-map (kbd "+")   'supa-set-tile-at-point-port-p)
(define-key supa-mode-map (kbd "e")   'supa-set-tile-at-point-electron)
(define-key supa-mode-map (kbd "B")   'supa-set-tile-at-point-bug)
(define-key supa-mode-map (kbd "[")   'supa-set-tile-at-point-chip-l)
(define-key supa-mode-map (kbd "]")   'supa-set-tile-at-point-chip-r)
(define-key supa-mode-map (kbd "0")   'supa-set-tile-at-point-hw0)
(define-key supa-mode-map (kbd "1")   'supa-set-tile-at-point-hw1)
(define-key supa-mode-map (kbd "2")   'supa-set-tile-at-point-hw2)
(define-key supa-mode-map (kbd "3")   'supa-set-tile-at-point-hw3)
(define-key supa-mode-map (kbd "4")   'supa-set-tile-at-point-hw4)
(define-key supa-mode-map (kbd "5")   'supa-set-tile-at-point-hw5)
(define-key supa-mode-map (kbd "6")   'supa-set-tile-at-point-hw6)
(define-key supa-mode-map (kbd "7")   'supa-set-tile-at-point-hw7)
(define-key supa-mode-map (kbd "8")   'supa-set-tile-at-point-hw8)
(define-key supa-mode-map (kbd "9")   'supa-set-tile-at-point-hw9)
(define-key supa-mode-map (kbd "{")   'supa-set-tile-at-point-chip-u)
(define-key supa-mode-map (kbd "}")   'supa-set-tile-at-point-chip-d)
